                ...
                ${companyList.map((company, index) => `
                    <div class="praktikum-company-card ${selectedCompany === company ? 'selected' : ''}">
                        <div class="praktikum-company-info">
                           ...
                           <p>${company.address}</p>
                           <p>${company.contact}</p>
                           ${company.website ? `<p><a href="${company.website.startsWith('http') ? company.website : `https://${company.website}`}" target="_blank" rel="noopener noreferrer" class="website-link">${t('companyWebsite')}</a></p>` : ''}
                        </div>
